...
Restaurante.ordenar("suprema", "san salvador", 4.99, True, 0.99)
Restaurante.ordenar("hawaiana", "la lipertad", 5.99, False, 0.00)
Restaurante.ordenar("meat lovers", "san salvador", 6.99, True, 0.99)
Restaurante.ordenar("hawaiana", "san salvador", 5.99, True, 1.99)
Restaurante.ordenar("cuatro quesos", "santa ana", 3.99, False, 0.00)
Restaurante.ordenar("super suprema", "la libertad", 7.99, True, 2.99)
